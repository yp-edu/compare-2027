...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'startSourceIngestion' | 'processSourceIngestion' | 'completeSourceIngestion';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
        ...
        error?:
          ...
          | null;
        parent?: {
          taskSlug?: ('inline' | 'startSourceIngestion' | 'processSourceIngestion' | 'completeSourceIngestion') | null;
          taskID?: string | null;
        };
        id?: string | null;
      }[]
