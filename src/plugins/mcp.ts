...
export const mcp = () =>
  mcpPlugin({
    collections: {
      ...
      'claim-evidence': {
        description:
          'Published evidence quotes and source locators that support structured claims.',
        enabled: readOnly,
      },
      claims: {
        description:
      ...
      'document-chunks': {
        description:
          'Published chunks of parsed source documents used for retrieval and citations.',
        enabled: readOnly,
      },
      parties: {
